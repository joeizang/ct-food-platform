  ...
  return (
    ...
    <article className="overflow-hidden rounded-lg shadow transition hover:shadow-lg mx-2 border bg-gradient-to-b from-[#76129b] to-[#15162c]">
      ...
      />
       ...
       <form action={registerBeneficiary} className="mt-5 md:ml-72 px-3">
             ...
             <div className="mt-10">
                 <button className="p-3 lg:w-3/5 w-full lg:ml-20 mb-5 bg-seance-800 hover:bg-seance-900 rounded-md active:ring-2 ring-seance-300 text-2xl text-seance-100 font-bold" type="submit" value="Register">
                   Register
                 </button>
             </div>
           </form>
