...
export default function ModalForm () {
  ...
  return (
<>
<div id="crud-modal" tabIndex={-1} aria-hidden="true" className="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full bg-gradient-to-b from-[#76129b] to-[#15162c]">
